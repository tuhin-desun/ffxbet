	...
	<Tab.Navigator
		...
		screenOptions={({ route }) => ({
			tabBarIcon: ({ focused, color }) => {
				...
				return focused?(
					<>
					<View style={{ borderTopWidth:3, width: 100, borderColor: Colors.secondary, top: -8}}></View>
					<View style={{ }}>
						<Ionicons style={{ alignSelf: "center", justifyContent: "center", alignItems: "center" }} name={iconName} size={iconSize} color={color} />
					</View></>):(
